<template>
    <v-app>
        ...
        >
            ...
            >
                ...
                <v-list-item link @click="zalbaFarmaceutView">
                 ...
                 <v-list-item link @click="ocenjivanjeView">
                    <v-list-item-icon>
        ...
        <v-main>
            ...
            <v-container fluid v-if="showOcenjivanje" :style="{width:'70vh'}">
                <Ocenjivanje/>
            </v-container>
