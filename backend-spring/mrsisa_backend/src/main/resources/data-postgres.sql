...
insert into osobe (adresa,broj_telefona,datum_rodjenja,drzava,grad,ime,prezime,mail,password,pol,promenjena_lozinka, obrisan, enabled) values ('Adresa dobavljaca','0651236680','1995-12-02','Srbija','Novi Sad','Mika','Mikic','imenkoprezimic94@gmaill.com','$2a$10$OLvOIAY5./MlO73z7NYLyeBRN6.vPmNo2R0s3sov86e3mpOkOMqxO',0,false, false, true); --sifra je 94
...
insert into termini(izvestaj, izvrsen, pocetak, kraj, apoteka_id) values ('', false, '2021-05-21 09:00', '2021-05-21 09:45', 1);
